class AboutUsSection extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <div class="icons">
      ...
      <a href="https://www.instagram.com/maulanafikriash/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
      <a href="https://www.linkedin.com/in/maulanafikriash/" target="_blank"><i
